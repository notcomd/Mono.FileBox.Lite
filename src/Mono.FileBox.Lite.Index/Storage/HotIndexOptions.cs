...
public sealed class HotIndexOptions
{
    ...
    /// 中文翻译：热点索引旁路侧写文件路径，被提升的条目会持久化于此，使进程冷启动时即可在内存中
    ...
    /// 中文翻译：是否在提升（促进入热点）时把热点集合持久化到 <see cref="HotFilePath"/>。
    /// </summary>
